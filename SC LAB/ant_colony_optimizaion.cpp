...
double Ant ::  trailLength(int** adj){
...
class Ant_Colony{
    ...
    void getProbability(Ant* );
    void updatePheromones();
    void setupAnts();
    void moveAnts();
    int selectNextCity(Ant*);
    void updateBest();
...
void Ant_Colony :: getProbability(Ant* a){
...
int Ant_Colony :: selectNextCity(Ant* a){
...
void Ant_Colony:: solve(){
    ...
    cout<<"\n\nMinimum cost for travelling : "<<minCost;
    cout<<"\n\nPath of traversal : ";
...
int main(){
    srand(time(0));
    Ant_Colony* ac = new Ant_Colony(5);
    ac->show();
    ac->solve();
    return 0;
}